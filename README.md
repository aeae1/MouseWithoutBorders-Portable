...
[RC10 settings and test guide](https://github.com/aeae1/MouseWithoutBorders-Portable/blob/release/1.0.1-rc.10/docs/RC10_SETTINGS.md) · [Folder-copy behavior and recovery guide](https://github.com/aeae1/MouseWithoutBorders-Portable/blob/release/1.0.1-rc.10/docs/RC6_TRANSFERS.md)
