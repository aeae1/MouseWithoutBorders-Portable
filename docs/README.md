...
- Real-Windows connection testing: **working through Test 12**. Version 1.0.0 Release Candidate 5 keeps that behavior, repairs the RC1 install-dialog ordering, restores locally managed shortcuts, fixes their responsive layout, and removes unclear disabled-option tooltips; a final portable/self-install, firewall, sleep/wake, shortcut, and two-machine regression pass remains worthwhile before 1.0.0 stable.
