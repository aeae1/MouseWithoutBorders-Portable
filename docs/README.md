...
- Real-Windows connection testing: **working through Test 12**. Version 1.0.0 Release Candidate 6 keeps that behavior, repairs the RC1 install-dialog ordering, restores locally managed shortcuts, fixes their responsive layout, clarifies disabled options, and separates normal mouse-edge switching from opt-in hotkeys; a final portable/self-install, firewall, sleep/wake, shortcut, and two-machine regression pass remains worthwhile before 1.0.0 stable.
